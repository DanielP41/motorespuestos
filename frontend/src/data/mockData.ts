...
export const mockRepuestos: Repuesto[] = [
    {
        ...
        imagenes: [{ id: 1, repuesto_id: 1, url: '/products/piston_studio.png', orden: 0, es_principal: true }],
    ...
    },
    {
        ...
        imagenes: [{ id: 2, repuesto_id: 2, url: '/products/pastillas_freno.png', orden: 0, es_principal: true }],
        compatibilidades: [],
        creado_en: '2024-01-15T00:00:00Z', actualizado_en: '2024-01-15T00:00:00Z',
    },
    {
        ...
        imagenes: [{ id: 3, repuesto_id: 3, url: '/products/cadena_transmision.png', orden: 0, es_principal: true }],
    ...
    },
    {
        ...
        imagenes: [{ id: 4, repuesto_id: 4, url: '/products/filtro_aire.png', orden: 0, es_principal: true }],
        compatibilidades: [],
    ...
    },
    {
        ...
        imagenes: [{ id: 6, repuesto_id: 6, url: '/products/disco_freno.png', orden: 0, es_principal: true }],
        compatibilidades: [],
    ...
    },
    {
        ...
        imagenes: [{ id: 8, repuesto_id: 8, url: '/products/aceite_motor.png', orden: 0, es_principal: true }],
        compatibilidades: [],
